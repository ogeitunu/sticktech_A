    ...
    <footer className="bg-[#0A0D66] text-white border-t border-[#1116A6] pt-16 pb-12 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid md:grid-cols-12 gap-8 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-sm text-white/80">
              <li>
                <button onClick={() => handleAudienceClick('School Owner / Proprietor')} className="hover:text-[#D4AF37] transition-colors text-left">
                  High Schools
                </button>
              </li>
              <li>
                <button onClick={() => handleAudienceClick('Graduate')} className="hover:text-[#D4AF37] transition-colors text-left">
                  Graduates
                </button>
              </li>
              <li>
                <button onClick={() => handleAudienceClick('SME / Business Owner')} className="hover:text-[#D4AF37] transition-colors text-left">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono text-white/60">
          <p>© 2026 StickTech Africa. All rights reserved.</p>
